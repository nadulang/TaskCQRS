...
namespace TaskCQRS.Migrations
{
    ...
    [Migration("20200304125024_AddCustomers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskCQRS.Domain.Entities.CustomerPayments", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TaskCQRS.Domain.Entities.Customers", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TaskCQRS.Domain.Entities.Merchants", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TaskCQRS.Domain.Entities.Products", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TaskCQRS.Domain.Entities.CustomerPayments", b =>
                {
                    b.HasOne("TaskCQRS.Domain.Entities.Customers", "customer")
                        .WithMany()
            ...
            modelBuilder.Entity("TaskCQRS.Domain.Entities.Products", b =>
                {
                    b.HasOne("TaskCQRS.Domain.Entities.Merchants", "merchant")
                        .WithMany()
